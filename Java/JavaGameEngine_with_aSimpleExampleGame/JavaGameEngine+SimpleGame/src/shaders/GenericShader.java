...
public abstract class GenericShader {
	...
	protected void loadMatrix(int location, Matrix4f mat) {
		mat.storeTranspose(matrixBuffer);
		GL20.glUniformMatrix4fv(location, false, matrixBuffer);
	}
//	I made this method to solve the bug in GUI (copied the code from the LWJGL2 in Matrix4f store method)
	protected void loadMatrixOGL(int location, Matrix4f mat) {

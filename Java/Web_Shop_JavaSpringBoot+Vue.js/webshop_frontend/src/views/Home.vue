    ...
    <div id="background-div" class="page-holder bg-cover">
      ...
      <div class="container py-5">
        <header class="text-left text-white py-5">
          <h3 class="mb-4 rounded"><a href="#start-shopping" class="bg-white px-2 py-2 rounded" id="heading">Welcome to your new shopping experience</a></h3>
          <p id="content" class="lead mb-0 bg-dark p-1 rounded">Simplistic, well equiped, good quality and Purchase Guarantee. <br>Make yourself comfortable and start your shopping-journey. We're sure you'll find something for you.</p>
        </header>
      </div>
    </div>
